...
router.get('/:id', async (req, res) => {
	...
	const docRef = await db.collection('accessories').doc(id).get()
...
router.post('/', async (req, res) => {
	...
	const docRef = await db.collection('accessories').add(object)
	res.send(docRef.id)
})
...
router.put('/:id', async (req, res) => {
	...
	const docRef = db.collection('accessories').doc(id)
